...
static float3 deathly_grayscale(float3 hdr_color)
{
...
static float3 deathly_harsh(float3 hdr_color)
{
    float lum = dot(hdr_color, float3(0.299, 0.587, 0.114));
...
static float3 deathly_bleed(float3 hdr_color)
{
    float lum = dot(hdr_color, float3(0.299, 0.587, 0.114));
...
static float3 deathly_veins(float3 hdr_color)
{
    float lum = dot(hdr_color, float3(0.299, 0.587, 0.114));
...
static float3 deathly_metal(float3 hdr_color)
{
    float lum = dot(hdr_color, float3(0.299, 0.587, 0.114));
...
static float3 deathly_brutal(float3 hdr_color)
{
    float lum = dot(hdr_color, float3(0.299, 0.587, 0.114));
...
static float3 deathly_void(float3 hdr_color)
{
    float lum = dot(hdr_color, float3(0.299, 0.587, 0.114));
...
static float3 deathly_grit(float3 hdr_color, float2 uv, float time)
{
    float lum = dot(hdr_color, float3(0.299, 0.587, 0.114));
