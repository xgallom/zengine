...
pub fn AutoArrayPoolMap(comptime K: type, comptime V: type, comptime options: struct {
    ...
    return struct {
        ...
        pub fn getOrNull(self: *const Self, key: K) ?V {
        ...
        pub fn create(self: *Self, key: K) !*V {
        ...
        pub fn insert(self: *Self, key: K, value: ValIn) !*V {
        ...
        pub fn put(self: *Self, key: K, value: ValIn) !*V {
...
pub fn AutoArrayPtrMap(comptime K: type, comptime V: type) type {
    return struct {
        ...
        pub fn insert(self: *Self, gpa: std.mem.Allocator, key: K, ptr: *V) !void {
        ...
        pub fn put(self: *Self, gpa: std.mem.Allocator, key: K, ptr: *V) !void {
            try self.map.put(gpa, key, ptr);
        }
...
pub fn ArrayPtrMap(comptime V: type) type {
    return struct {
        ...
        pub fn put(self: *Self, gpa: std.mem.Allocator, key: []const u8, ptr: *V) !void {
            try self.map.put(gpa, key, ptr);
        }
